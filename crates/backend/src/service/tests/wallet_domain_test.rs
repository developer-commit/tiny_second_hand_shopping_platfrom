...
fn test_eth_escrow_lifecycle() {
    ...
    let escrows = vec![
        ("ETH".to_string(), "pending_deposit".to_string(), Decimal::from_f64(10.0).unwrap()),
    ];
    ...
    let escrows_deposited = vec![
        ("ETH".to_string(), "deposited".to_string(), Decimal::from_f64(10.0).unwrap()),
    ];
    ...
    let escrows_misc = vec![
        ("ETH".to_string(), "received".to_string(), Decimal::from_f64(5.0).unwrap()),
        ("ETH".to_string(), "disputed".to_string(), Decimal::from_f64(5.0).unwrap()),
    ];
...
fn test_mixed_currencies() {
    let escrows = vec![
        ("ETH".to_string(), "pending_deposit".to_string(), Decimal::from_f64(10.0).unwrap()),
        ("ETH".to_string(), "deposited".to_string(), Decimal::from_f64(10.0).unwrap()),
        ("UNSUPPORTED".to_string(), "deposited".to_string(), Decimal::from_f64(20.0).unwrap()),
    ];
