...
async fn test_sign_up_success() {
    ...
    let db = MockDatabase::new(DatabaseBackend::Postgres)
        ...
        .append_query_results([vec![crate::db::entity::user::Model {
            id: 1,
        ...
        .append_query_results([vec![crate::db::entity::wallet::Model {
            id: 1,
            user_id: 1,
    ...
    mock_verification
        ...
        .with(
            ...
            mockall::predicate::eq("dummy_code"),
        )
        .times(1)
    ...
    mock_wallet.expect_create_wallet().times(1).returning(|_| {
        Ok(NewWalletInfo {
            eth_address: "0xdummy".to_string(),
